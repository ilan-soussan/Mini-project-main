...
//		assertNull(t.findIntsersections(new Ray(new Point3D(0,0,5),new Vector(0,0,1))));
...
//		assertArrayEquals(new ArrayList<Point3D>(Arrays.asList(new Point3D(-1,0,0))).toArray(),t.findIntsersections(new Ray(new Point3D(-1,1,1),new Vector(0,-1,-1))).toArray() );
//		// =============== Boundary Values Tests ==================
