...
public class LightsTests {
	...
	/**
	 * Produce a picture of a two triangles lighted by spotLight, PointLight, DirectionalLight
	 */
	@Test
	public void trianglesAll(){
		scene2.geometries.add(triangle1.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)),
				triangle2.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)));
		scene2.lights.add(new PointLight(new Color(500, 250, 250), new Point3D(100, -100, -100)) //
				.setKl(0.0005).setKq(0.0005));
		scene2.lights.add(new DirectionalLight(new Color(0, 75, 75), new Vector(0, 0, -1)));
	...
	/**
	 * Produce a picture of a sphere lighted by spotLight, PointLight, DirectionalLight
	 */
	@Test
	public void sphereAll() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new SpotLight(new Color(500, 300, 0), new Point3D(-40, -40, 40), new Vector(1, 1, -2)) //
				.setKl(0.00001).setKq(0.00000001));

		scene1.lights.add(new SpotLight(new Color(600, 200, 100), new Point3D(0, 40, 40), new Vector(0, -1, -2)) //
				.setKl(0.000000001).setKq(0.000001));

		scene1.lights.add(new DirectionalLight(new Color(200, 200, 200), new Vector(1, 1, -1)));
