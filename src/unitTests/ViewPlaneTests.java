...
public class ViewPlaneTests {
	...
	public void testConstructRayThroughPixelWithSphere() {
        ...
        assertEquals("Error with camere constructRayThroughPixel with sphere with 2 intersections",2,count);
        ...
        assertEquals("Error with camere constructRayThroughPixel with sphere with 18 intersections",18,count);
        ...
        assertEquals("Error with camere constructRayThroughPixel with sphere with 10 intersections",10,count);
        ...
        assertEquals("Error with camere constructRayThroughPixel with sphere with 9 intersections",9,count);
        ...
        assertEquals("Error with camere constructRayThroughPixel with sphere with 0 intersections",0,count);
    }
	@Test
	public void testConstructRayThroughPixelWithPlane() {
        ...
        assertEquals("Error with camere constructRayThroughPixel with plane thet parallel to viewPanel",9,count);
        ...
        assertEquals("Error with camere constructRayThroughPixel with plane thet not parallel to viewPanel",9,count);

        //test 2: 6 intersection points
        Camera Cam2 = new Camera(Point3D.ZERO,new Vector(0,0,1),new Vector(1,1,0)).setDistance(1);
        ...
        assertEquals("Error with camere constructRayThroughPixel with plane thet not parallel to viewPanel",6,count);
    }
	@Test
	public void testConstructRayThroughPixelWithTriangle() {
        ...
        assertEquals("Error with camere constructRayThroughPixel with triangle with one point",1,count);
        //test 2
        ...
        assertEquals("Error with camere constructRayThroughPixel with triangle with more then one",2,count);
    }
